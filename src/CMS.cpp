...
@date: 5/ 10/ 2020 - 11:04:30
@guidance: Prof. Sarang Ajnadkar
*/
#include<iostream>
#include<vector>
#include<stdio.h>
...
int main()
{
	...
	while(i)
	{
		system("CLS");
		cout<<"\t\t\t-----------------------------------------------\n";
		cout<<"\t\t\t     M.S.Gosavi Polytechnic Admin Portal\n";
		cout<<"\t\t\t-----------------------------------------------\n";
		...
		switch(i)
		{
			...
			case 0 :
				...
				break;
			case 9 :
				cout<<"\n\t\t\tKaiwalya Koparkar ( SYCO/05 )";
				cout<<"\n\t\t\tVadanya Wabale ( SYCO/08 )";
				cout<<"\n\t\t\tMrunaal Chincholikar ( SYCO/36 )";
				cout<<"\n\t\t\tPragati More ( SYCO/38 )";
				break;
			default :
				cout<<"\nWRONG CHOICE!!!\nTRY AGAIN";
		}
